import {StatData,StatName, StatItem, ProductStat, ProductTitle, Icon, Discription, BtnAdd, ProductCard, RecomendedContainer,NotRecomended, Recomended } from './ProductsItem.styled';
  ...
  return (
      <ProductCard key={id}>
        <RecomendedContainer>
          ...
          <BtnAdd>
            Add <AiOutlineArrowRight style={{ fontSize: '14px', color: `${theme.colors.orange}`, fontWeight: 'bold',  marginLeft: '8px'}} />
          </BtnAdd>
        </RecomendedContainer>
        <Discription>
          <Icon>
